...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        */
        ...
        {
            int numValueException = 0;
            try
            {
                numValueException = int.Parse(inputValue);
            }
        ...
        checked
        {
            // checked blocks specically check for overflow exceptions
            try
            {
                int num1 = int.MaxValue;
                int num2 = int.MaxValue;
                int resultException = num1 + num2;
                Console.WriteLine("resultException: " + resultException);
            }
        ...
        try
        {
            ...
            numbersException[5] = 10;
            Console.WriteLine("Number at index 5: " + numbersException[5]);
        }
        ...
        try
        {
            int num3 = 10;
            int num4 = 0;
            int resultException2 = num3 / num4;
            Console.WriteLine("resultException: " + resultException2);
        }
